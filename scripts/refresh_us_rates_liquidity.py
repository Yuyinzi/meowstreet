...
def refresh(
    ...
    import_credit=import_us_corporate_credit.import_workbook,
):
    con = connect(db_path)
    try:
...
def main(
    ...
    _print_imported("corporate credit", result["credit_imported"])
    return 0
